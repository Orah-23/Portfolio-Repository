...
The Virtual CV is built with **HTML**, **CSS**, and **JavaScript**, featuring a clean layout, animated skill bars, and responsive design for compatibility across devices.
